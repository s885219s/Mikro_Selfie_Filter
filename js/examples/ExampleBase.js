...
(function(lib, cjs) {
	...
	(lib.ExampleBase = function(
			...
			cameraResolution,
			// That's the size of the BitmapData BRF will work on.攝影機畫面大小
			brfResolution,
			// Let's limit the area of detailed face analysis
			// to achieve better performance. 攝影機人臉辨識的範圍(較小)
			brfRoi,
...
//			_this._container.addChild(_this._stats);
		...
		_this.updateInput = function() {
			_this._videoBitmapData.drawImage(_this._camera, 0, 0, _this._cameraResolution.width, _this._cameraResolution.height); //攝影機畫面
			_this._brfBmd.drawImage(_this._camera, 0, 0, _this._cameraResolution.width, _this._cameraResolution.height);	//人臉偵測的線
